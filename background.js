...
const GEMINI_API_KEY = "AIzaSyCPwYwwI-fSGP7ebbjrDSz7SIDiByuyFXs";
...
function processTelemetry(metrics, tabId) {
    ...
    // Send metrics to local Python server
...
async function summarizeWithGemini(rawText, tabId) {
    ...
    3. Use <strong style="color: #e74c3c;"> for critical warnings or important terms.
    4. If the text contains links, preserve them as <a href="..." style="color: #2980b9; text-decoration: underline;">.
    5. Return ONLY the raw HTML (no markdown backticks).
